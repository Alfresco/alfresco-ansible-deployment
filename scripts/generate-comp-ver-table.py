...
#Generate components version table in docs/README.md based on extra-values.yml
...
def modify_table():
    ...
    a_file = open("docs/README.md", "r", encoding="utf-8")
    lines = a_file.readlines()
    a_file.close()

    new_file = open("docs/README.md", "w", encoding="utf-8")
    for line in lines:
